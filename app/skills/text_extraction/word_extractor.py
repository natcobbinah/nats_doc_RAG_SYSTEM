    ...
    def extract_content_from_document(self, stream: io.BytesIO, blob_name: str, source_url: str) -> List[Dict]:
        ...
        try:
            ...
            doc_metadata = {
                ...
                "modification_data": props.modified.isoformat() if props.modified else "",
                "total_pages": 1,
                "file_extension": "docx",
                "url": source_url
            }
